...
if ( ! function_exists( 'artorias_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function artorias_get_filter_items( $params ) {
		...
		return apply_filters( 'artorias_filter_get_filter_items', $items, $params );
	}
}
